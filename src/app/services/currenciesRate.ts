...
export const fetchCurrenciesRate = (main: Currency, to: Currency): Observable<number> => {
  // This free API use USD as base currency
  const promise = fetchJsonp(`https://openexchangerates.org/api/latest.json?app_id=${ACCESS_KEY}&symbols=${main},${to}`, {
